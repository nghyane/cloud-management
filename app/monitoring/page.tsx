      ...
      <SidebarInset className="flex flex-col">
        ...
        <div className="flex-1 overflow-auto bg-gradient-to-b from-background/80 to-background dark:from-background/40 dark:to-background backdrop-blur-sm">
          <div className="container max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-8">
              <h1 className="text-3xl font-bold tracking-tight mb-2">Monitoring</h1>
              <p className="text-muted-foreground">
                Monitor metrics, logs, alerts, and health checks across all your cloud resources
              </p>
            </div>
            
            <div className="flex items-center justify-center h-64 border rounded-lg bg-muted/20">
              <p className="text-muted-foreground">Monitoring interface will be available soon</p>
            </div>
          </div>
        </div>
      </SidebarInset>
